...
\chapter{Resultados 1}\label{resultados-1}
...
satisfacción/insatifacción de los estudiantes; la
\textbf{\emph{Satisfacción total}} y la \textbf{\emph{Satisfacción
neta}}. La primera alude al porcentaje de alumnos que evalúan a cada
servicio/espacio con nota 6 ó 7, en cambios la satisfacción neta,
corresponde a la diferencia del porcentaje de estudiantesque evalúan con
nota 6 ó 7, menos aquellos que evalúan con nota inferior a 5, todo ello
expresado en porcentaje. En general, será esta última el valor
comparativo en la mayoría de los gráficos y tablas del informe.
...
El siguiente gráfico, señala los resultados en la presente medición
(2018-2), respecto de las mediciones ateriores, tanto en lo que respecta
a la Satisfacción Neta, como en la Satisfacción (nota 6 y 7). Se puede
apreciar que en ambas se visualizan tendencias al alza, así la
satisfacción neta en el 2018-2 alcanza un 51\%, y la satifacción total,
un 63\%. Respecto de las mediciones anteriores, equivalente con lo
registrado en la primera medición (2014-2). En ambos casos, los valores
son cercanos a lo registrado en la medición 2014-2.
...
\textbf{2.1.2) Evaluación con la Atención entregada por el IGS}
...
\section{Satisfacción con Actores, áreas o espacios específicos del
IGS}\label{satisfaccion-con-actores-areas-o-espacios-especificos-del-igs}

\textbf{2.2.1) Satisfacción con Docentes}
...
\section{Satisfacción con Infraestructura y Otros Espacios Físicos
Comunes del
IGS}\label{satisfaccion-con-infraestructura-y-otros-espacios-fisicos-comunes-del-igs}

\textbf{2.2.2) Satisfacción con la Infraestructura}
...
\textbf{2.2.3) Satisfacción con Espacios o Servicos Digitales}
...
\textbf{2.2.4) Satisfacción con Otros Servicios del IGS}
