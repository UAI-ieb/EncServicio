...
ggplot(GrafInfra1, aes(x=GrafInfra1$medicion, y=GrafInfra1$Valor, group = Tipo, colour=Tipo, label = paste(round(GrafInfra1$Valor, 0),"%", sep=""))) + 
  geom_line(size=0.9)  + 
  geom_text(nudge_x = 0.3 , color= "black",size=2.7) +
  geom_point( size=2, shape=21, fill="white") + 
  theme_minimal()+
  labs(
    x = "Mediciones",
...
GrafSClases=ggplot(DataSedeSClases, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100,0),"%",sep = ""))) +
  geom_line(size=1)  + 
  geom_text(nudge_x = 0.1, nudge_y = 0.05 , color= DataSedeSClases$colores, size=2.7) +
  geom_point( size=2, shape=21, fill="white") + 
  theme (legend.position = "none",
...
GrafLab=ggplot(DataSedeLab, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=1)  + 
  geom_text(nudge_x = 0, nudge_y = 0.03 , color= DataSedeLab$colores, size=2.7) +
  geom_point( size=2, shape=21, fill="white") + 
  theme (legend.position = "none",
         axis.text.x = element_text (angle = 90, vjust = 0.5))+
  labs(
...
GrafCaf=ggplot(DataSedeCaf, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=1)  + 
  geom_text(nudge_x = 0, nudge_y = 0.03 , color= DataSedeCaf$colores, size=2.7) +
  geom_point(size=2, shape=21, fill="white") + 
  theme (legend.position = "none",
...
GrafBiblio=ggplot(DataSedeBiblio, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=1)  + 
  geom_text(nudge_x = 0.4, nudge_y = 0.08 , color= DataSedeBiblio$colores, size=2.4) +
  geom_point( size=2, shape=21, fill="white") + 
  theme (axis.text.x = element_text (angle = 90, vjust = 0.5))+
  labs(
    x = "Mediciones",
    y = "% de Satisfacción Neta",
    title = "Gráfico 2.3.6a",
...
graf_Ind + facet_grid(. ~ Preguntas) +
          ...
          size = 5.8, color = "#af4605", face = "bold"),
...
graf_P2=ggplot(data=df_virtual1[df_virtual1$N_Preg =="P2",], aes(x=as.factor(Nota), y=Porc2))+
  ...
  geom_text(aes(label=paste0(round(Porc2*100,digits = 0),"%",sep=""))
            ,position=position_stack(vjust=0.7),vjust=0.03, color="#66625f", size=2.7)+
  labs(
    x = "Notas (1 a 7)",
    y = "%",
    title = "Gráfico 3.2",
...
graf_P7=ggplot(data=df_virtual1[df_virtual1$N_Preg =="P7" & df_virtual1$Interfaz =="Virtual" ,], aes(x=as.factor(Nota), y=Porc2))+
  geom_bar(stat = "identity", fill="Orange")+
  geom_text(aes(label=paste0(round(Porc2*100,digits = 0),"%",sep=""))
            ,position=position_stack(vjust=0.7),vjust=0.03, color="black", size=2.5) + 
      labs(
    x = "Notas (1 a 7)",
    y = "%",
    title = "Gráfico 3.5",
