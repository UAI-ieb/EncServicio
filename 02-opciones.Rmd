...
GrafGlobal=ggplot(DataSedeGlobal, aes(x=medicion, y=Valor, group = Sede, colour=Sede,label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    title = "Gráfico 2.1.2",
    subtitle = "Satisfacción Neta con servicio enregado por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafAtencion=ggplot(DataSedeAtencion, aes(x=medicion, y=Valor, group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.1.4",
    subtitle = "Satisfacción Neta con la Atención Recibida por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafRecom1=ggplot(DataRecom1, aes(Valor, Var1, color = DataRecom1$colores, label = Valor2)) +
  ...
  scale_y_discrete(limit = c("Definitivamente NO","Probablemente NO","NO sé", "Probablemente SI","Definitivamente SI")) +
    ...
    y = "Grupos",
    title = "Gráfico 2.1.5",
    subtitle = "Disposición a Recomendar el Instituto por Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafDocente=ggplot(DataSedeDocente, aes(x=medicion, y=Valor, group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.2.2",
    subtitle = "Satisfacción Neta con Docentes por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafMejDoc= ggplot(MejDocente4, aes(MejDocente4$Valor, MejDocente4$Aspecto, label = paste(round(MejDocente4$Valor*100, 0), sep="","%"))) +
  ...
  labs(
    ...
    y = "Mediciones",
    title = "Gráfico 2.2.3",
    subtitle = "Mejoras sugeridas en desempeño docente",
    caption = "\nUnidad de Análisis Institucional"
  )
...
ggplot(GrafInfra1, aes(x=GrafInfra1$medicion, y=GrafInfra1$Valor, group = Tipo, colour=Tipo, label = paste(round(GrafInfra1$Valor, 0),"%"))) + 
  ...
  labs(
    ...
    subtitle = "Satisfacción Neta de Espacios Físicos",
    caption = "\nUnidad de Análisis Institucional"
  )
```
...
GrafInfra=ggplot(DataSedeInfra, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    subtitle = "Satisfacción Neta con Infraestructura por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafMejInfra= ggplot(MejInfra4, aes(MejInfra4$Valor, MejInfra4$Aspecto, label = paste(round(MejInfra4$Valor*100, 0), sep="","%"))) +
  ...
  labs(
    ...
    subtitle = "Mejoras sugeridas en Infraestructura",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafSClases=ggplot(DataSedeSClases, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.3.2",
    subtitle = "Satisfacción Neta con Sala de Clases por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafBanos=ggplot(DataSedeBanos, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.3.3",
    subtitle = "Satisfacción Neta con Baños por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafLab=ggplot(DataSedeLab, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.3.4",
    subtitle = "Satisfacción Neta con Laboratorio por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafCaf=ggplot(DataSedeCaf, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.3.5",
    subtitle = "Satisfacción Neta con Cafetería por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafBiblio=ggplot(DataSedeBiblio, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.4.1",
    subtitle = "Satisfacción Neta con Biblioteca por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafMejBiblio= ggplot(MejBiblio4, aes(MejBiblio4$Valor, MejBiblio4$Aspecto, label = paste(round(MejBiblio4$Valor*100, 0), sep="","%"))) +
  ...
  labs(
    ...
    y = "Mediciones",
    title = "Gráfico 2.4.2",
    subtitle = "Mejoras sugeridas en Biblioteca",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafEbook=ggplot(DataSedeEbook, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.5.2",
    subtitle = "Satisfacción Neta con Ebook por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafWifi=ggplot(DataSedeWifi, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.5.3",
    subtitle = "Satisfacción con Wifi por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafIEBV=ggplot(DataSedeIEBV, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.5.4",
    subtitle = "Satisfacción con IEB Virtual por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafCajas=ggplot(DataSedeCajas, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    ...
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.5.6",
    subtitle = "Satisfacción Neta con Serv.Solicitudes por Sede y Medición",
    caption = "\nUnidad de Análisis Institucional"
  )
