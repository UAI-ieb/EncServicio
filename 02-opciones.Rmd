...
GrafMejDoc= ggplot(MejDocente4, aes(MejDocente4$Valor, MejDocente4$Aspecto, label = paste(round(MejDocente4$Valor*100, 0), sep="","%"))) +
  ...
  labs(
    x = "Porcentaje de Satisfacción",
    y = "Mediciones",
    title = "Gráfico : Mejoras sugeridas en desempeño docente",
...
GrafInfra=ggplot(DataSedeInfra, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    x = "Mediciones",
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.2.2c: Satisfacción Neta con Infraestructura por Sede y Medición",
    subtitle = "Encuesta de Servicios IGS",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafSClases=ggplot(DataSedeSClases, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),"%"))) +
  ...
  labs(
    x = "Mediciones",
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.2.2d: Satisfacción Neta con Sala de Clases por Sede y Medición",
    subtitle = "Encuesta de Servicios IGS",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafBiblio=ggplot(DataSedeBiblio, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    x = "Mediciones",
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.2.2e: Satisfacción Neta con Biblioteca por Sede y Medición",
    subtitle = "Encuesta de Servicios IGS",
    caption = "\nUnidad de Análisis Institucional"
  )
...
GrafBanos=ggplot(DataSedeBanos, aes(x=medicion, y=Valor,group = Sede, colour=Sede, label = paste(round(Valor*100, 0),sep="","%"))) +
  ...
  labs(
    x = "Mediciones",
    y = "% de Satisfaccion Neta",
    title = "Gráfico 2.2.2f: Satisfacción Neta con Baños por Sede y Medición",
    subtitle = "Encuesta de Servicios IGS",
    caption = "\nUnidad de Análisis Institucional"
  )
