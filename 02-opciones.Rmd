...
GrafBanos2=ggplot(DataJorBanos, aes(x=medicion, y=Valor, group = Jornada, colour=Sede,label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=0.5)  + 
  geom_text(nudge_x =0.3,nudge_y =0.145 , color=DataJorBanos$colores, size=2.4) +
  geom_point( size=0.5, shape=21, fill="white") + 
  theme (legend.position = "none",
         axis.text.x = element_text (angle = 90, vjust = 0.5))+
  labs(
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
GrafIEB2=ggplot(DataJorWifi, aes(x=medicion, y=Valor, group = Jornada, colour=Sede,label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=0.5)  + 
  ...
  labs(
    x = "Mediciones",
    y = "% de Satisfacción Neta",
    title = "Gráfico 2.3.9b",
    subtitle = "Satisfacción Neta con IEB por Sede y Jornada",
    caption = "\nUnidad de Análisis Institucional"
  )  +
theme (axis.text.x = element_text(face="plain", colour="black",                     size=rel(0.8)),axis.text.y = element_text(face="plain",                             colour="black", size=rel(0.7), angle=90, hjust=0.5))

GrafIEB2 + facet_grid(factor(Jornada)~factor(Sede))
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
GrafServSol2=ggplot(DataJorServSol, aes(x=medicion, y=Valor, group = Jornada, colour=Sede,label = paste(round(Valor*100, 0),"%", sep=""))) +
  geom_line(size=0.5)  + 
  geom_text(nudge_x = 0,nudge_y = 0.05 , color= "black", size=2) +
  geom_point( size=0.5, shape=21, fill="white") + 
  theme (axis.text.x = element_text (angle = 90, vjust = 0.5),legend.position = "none")+
  labs(
    x = "Mediciones",
    y = "% de Satisfacción Neta",
    title = "Gráfico 2.3.11b",
    subtitle = "Satisfacción Neta con Serv.Solicitudes por Sede y Jornada",
    caption = "\nUnidad de Análisis Institucional"
  )  +
theme (axis.text.x = element_text(face="plain", colour="black",                     size=rel(0.8)),axis.text.y = element_text(face="plain",                             colour="black", size=rel(0.7), angle=90, hjust=0.5))

GrafServSol2 + facet_grid(factor(Jornada)~factor(Sede))
